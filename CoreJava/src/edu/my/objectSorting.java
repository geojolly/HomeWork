...
public class objectSorting {
	...
	public static void main(String args[]) {
		...
		// Sorting Order Object on natural order - ascending, uses comparable
		Collections.sort(orders);

		// printing sorted collection
		System.out.println("List of Order object sorted in natural order : " + orders);

		// Sorting object in descending order in Java. uses comparable
...
class Order implements Comparable<Order> {
	...
	/*
	 * Another implementation or Comparator interface to sort list of Order
	...
	public boolean equals(Object o) {
		...
		if (o == null || this.getClass() != o.getClass())
			return false;
		Order guest = (Order) o;
		return (this.orderId == guest.orderId) && (this.orderId == guest.amount)
				&& (this.customer != null && customer.equals(guest.customer));
	}
